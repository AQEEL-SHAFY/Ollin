...
class _AddContactState extends State<AddContact> {
  final EmergencyContact addContact = EmergencyContact.newContact( "", "");
            ...
            Container(
              ...
              child: ElevatedButton(
                ...
                onPressed: (
                  ...
                  addContact.name = nameController.value.text;
                  addContact.number = relationshipController.value.text;
                  addContact.number = numberController.value.text;
